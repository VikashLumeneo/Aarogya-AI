    ...
    <section className="about">
      ...
      <div className="about-bottom">
        ...
        <div className="details">
          ...
          <p>
            <b>Automatic DICOM Retrieval</b> Arogya AI integrates directly with
            PACS systems and retrieves imaging studies the moment they’re
            available — no manual download, no waiting.
          </p>

          <p>
            <b>Deep Learning Organ Segmentation</b> Organs are segmented and
            abnormalities are detected using models trained on clinical imaging
            datasets.
          </p>

          <p>
            <b>Structured Radiology Reports</b> Reports are auto-generated in
            physician-reviewable format, reducing interpretation time.
          </p>
